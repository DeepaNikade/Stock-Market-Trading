...
import StateMasterRecords from "./stateMasterRecord";

const StateMasterForm = (data) => {
  const [scriptMasterData, setStateMasterData] = useState({
    id:"",
    cityName: "",
    pinCode: "",
    subArea: "",
  ...
  function handleInsertStateMasterData() {
    insertStateMasterMutation.mutate(stateMasterData);
  }
            ...
            <Grid container spacing={3}>
              ...
              <Grid xs={12} sm={4} item>
                <TextField
                  ...
                  name="cityName"
                  value={scriptMasterData.cityName}
                  fullWidth
                  required
                />
              </Grid>
              <Grid xs={12} sm={4} item>
                <TextField
                  ...
                  onChange={handleInputData}
                  name="pincode"
                  value={scriptMasterData.pinCode || ""}
                  fullWidth
                />
              </Grid>
              <Grid xs={12} sm={4} item>
                <TextField
                  ...
                  onChange={handleInputData}
                  name="Sub Area"
                  value={scriptMasterData.subArea || ""}
                  fullWidth
                  required
                />
              </Grid>
              ...
              <Grid xs={12} sm={4} item>
                <TextField
                  ...
                  onChange={handleInputData}
                  name="companyCode"
                  value={scriptMasterData.companyCode || ""}
                  fullWidth
                  required
                />
              </Grid>
